		...
		<form action="editproduct" method="post">
			<div class="row justify-content-end">
				...
				<div class="col col-lg-5 col-md-6 mt-5 cart-wrap ftco-animate">
					<p>
						<label>Mã: ${product.getId()}</label>
					</p>
					<p>
						<input name="id" type="text" hidden="true"
							style="width: 300px" value="${product.getId()}">
					</p>
					<p>
					...
					<p>
						<input name="name" type="text" placeholder="  Nhap ten..."
							style="width: 300px" value="${product.getName()}">
					</p>
					<p>
					...
					<p>
						<input name="image" type="text" placeholder="  Nhap link anh..."
							style="width: 300px" value="${product.getImage()}">
					</p>
					<p>
					...
					<p>
						<input name="price" type="number"
							placeholder="  Nhap gia..." min="0" style="width: 300px" value="${product.getPrice()}">
					</p>
					<p>
